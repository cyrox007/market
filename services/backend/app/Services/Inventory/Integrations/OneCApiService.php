 ...
 */
class OneCApiService implements InventorySyncInterface
{
    ...
    public function __construct()
    {
        ...
        $this->apiKey = config('services.onec.api_key', '');
        $this->timeout = config('services.onec.timeout', 30);
    }

    /**
     * Синхронизировать созданный заказ с 1С
     */
    ...
    /**
     * Синхронизировать отмененный заказ с 1С
     */
    ...
    /**
     * Синхронизировать завершенный заказ с 1С
     */
    ...
    /**
     * Получить информацию о товаре из 1С по артикулу
     */
    ...
    /**
     * Форматировать заказ для отправки в 1С
     */
