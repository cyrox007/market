      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 text-lg mb-2">
                Все документы представлены в актуальной версии и соответствуют действующему
                законодательству РФ.
              </p>
            ...
            <div key={idx} className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
              <div className={`bg-${category.color}-50 p-6 border-b border-gray-200`}>
                <div className="flex items-center gap-4">
                  <div
                    className={`w-14 h-14 bg-${category.color}-600 rounded-full flex items-center justify-center`}
                  >
                  ...
                  {category.files.map((file, fileIdx) => (
                    ...
                    >
                      <div className="flex items-center gap-4 flex-1">
                        <div
                          className={`w-12 h-12 ${docColors(category.color).bg} rounded-lg flex items-center justify-center flex-shrink-0`}
                        >
                          <Icon
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-yellow-50 rounded-2xl p-8 text-center">
            ...
            <a
              href="mailto:docs@svetofor-mebel.ru"
