        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-red-50 rounded-2xl p-8 text-center">
            ...
            <a
              ...
              className="text-2xl font-bold text-red-600 hover:underline block mb-2"
            >
              +7 (800) 123-45-67
            </a>
          ...
          <div className="bg-yellow-50 rounded-2xl p-8 text-center">
            ...
            <a
              href="mailto:info@svetofor-mebel.ru"
              className="text-xl font-bold text-yellow-600 hover:underline block mb-2"
            >
              info@svetofor-mebel.ru
            </a>
            <a
              href="mailto:support@svetofor-mebel.ru"
              className="text-xl font-bold text-yellow-600 hover:underline block"
            >
          ...
          <div className="bg-green-50 rounded-2xl p-8 text-center">
            ...
            <p className="text-lg font-semibold text-gray-900 mb-2">г. Москва, ул. Ленина, 123</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                email: 'support@svetofor-mebel.ru',
                icon: Headset,
                color: 'yellow',
              },
              {
                ...
                email: 'delivery@svetofor-mebel.ru',
                icon: Truck,
                color: 'green',
              },
              {
                title: 'Отдел возвратов',
                phone: '+7 (800) 123-45-70',
                email: 'returns@svetofor-mebel.ru',
                icon: Undo2,
                color: 'red',
              },
              {
                title: 'Отдел кадров',
                phone: '+7 (800) 123-45-71',
                email: 'hr@svetofor-mebel.ru',
                icon: Users,
                color: 'yellow',
              },
              {
                title: 'Бухгалтерия',
                phone: '+7 (800) 123-45-72',
                email: 'accounting@svetofor-mebel.ru',
                icon: Calculator,
                color: 'green',
              },
            ].map((dept, idx) => (
              <div key={idx} className={`bg-${dept.color}-50 rounded-xl p-6`}>
                <div
                  className={`w-12 h-12 bg-${dept.color}-600 rounded-full flex items-center justify-center mb-4`}
                >
