...
const chatsData: Chat[] = [
	{
		...
		unreadCount: 2,
		messages: [
			{ id: 1, text: 'Здравствуйте! Когда будет доставлен мой заказ?', sender: 'user', time: '09:15' },
			{ id: 2, text: 'Добрый день! Ваш заказ находится на складе и будет отправлен сегодня.', sender: 'seller', time: '09:45' },
	...
	},
	{
		...
		unreadCount: 0,
		messages: [
			{ id: 1, text: 'Здравствуйте! Получил заказ, все отлично!', sender: 'user', time: 'Вчера 14:20' },
			{ id: 2, text: 'Рады, что вам понравилось! Спасибо за покупку!', sender: 'seller', time: 'Вчера 14:35' }
		]
	},
	{
		id: 3,
		...
		unreadCount: 1,
		messages: [
			{ id: 1, text: 'Добрый день! Интересует диван из вашего каталога.', sender: 'user', time: '2 дня назад 11:00' },
			{ id: 2, text: 'Здравствуйте! С удовольствием расскажем о нем подробнее.', sender: 'seller', time: '2 дня назад 11:20' },
		...
		<div className="min-h-screen bg-gray-50 flex flex-col">
			...
			<div className="flex-1 flex flex-col">
				<div className="max-w-7xl w-full mx-auto px-4 py-6">
					...
					{/* Chat Interface */}
					<div className="bg-white rounded-3xl shadow-sm overflow-hidden flex" style={{ height: 'calc(100vh - 300px)', minHeight: '500px' }}>
						{/* Chat List */}
							...
							<div className="flex-1 overflow-y-auto">
								{chats.map((chat) => (
									<div
										...
										className={`p-4 border-b border-gray-50 cursor-pointer transition-all ${activeChat?.id === chat.id ? 'bg-red-50/50' : 'hover:bg-gray-50'
											}`}
									>
									...
									{activeChat.messages.map((message) => (
										...
										>
											...
											>
												...
												<p
													className={`text-xs mt-1.5 ${message.sender === 'user' ? 'text-red-100' : 'text-gray-500'
														}`}
												>
													{message.time}
												</p>
