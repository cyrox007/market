...
const sets = [
	{
		...
		price: 189990,
		oldPrice: 229990,
		image: 'https://readdy.ai/api/search-image?query=elegant%20complete%20bedroom%20set%20with%20bed%20dresser%20nightstands%20wardrobe%20in%20classic%20style%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=500&height=350&seq=set1&orientation=landscape',
		rating: 4.9,
		reviews: 89,
		discount: 17,
		itemsCount: 5,
	...
	},
	{
		...
		price: 234990,
		oldPrice: 279990,
		image: 'https://readdy.ai/api/search-image?query=modern%20complete%20living%20room%20set%20with%20sofa%20tv%20stand%20coffee%20table%20shelves%20in%20minimalist%20style%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=500&height=350&seq=set2&orientation=landscape',
		rating: 4.8,
		reviews: 127,
		discount: 16,
		itemsCount: 6,
	...
	},
	{
		...
		price: 299990,
		oldPrice: 349990,
		image: 'https://readdy.ai/api/search-image?query=scandinavian%20complete%20kitchen%20set%20with%20cabinets%20dining%20table%20chairs%20in%20light%20wood%20style%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=500&height=350&seq=set3&orientation=landscape',
		rating: 4.7,
		reviews: 156,
		discount: 14,
		itemsCount: 8,
	...
	},
	{
		...
		price: 149990,
		oldPrice: 179990,
		image: 'https://readdy.ai/api/search-image?query=colorful%20complete%20kids%20bedroom%20set%20with%20bed%20desk%20wardrobe%20shelves%20in%20bright%20cheerful%20style%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=500&height=350&seq=set4&orientation=landscape',
		rating: 4.9,
		reviews: 73,
		discount: 17,
		itemsCount: 6,
	...
	},
	{
		...
		price: 89990,
		oldPrice: 109990,
		image: 'https://readdy.ai/api/search-image?query=elegant%20complete%20hallway%20furniture%20set%20with%20wardrobe%20bench%20shoe%20storage%20mirror%20hooks%20in%20classic%20style%20professional%20furniture%20photography%20clean%20simple%20background&width=500&height=350&seq=set8&orientation=landscape',
		rating: 4.5,
		reviews: 45,
		discount: 18,
		itemsCount: 4,
			...
			<div className="max-w-[1280px] mx-auto px-4 py-4 md:py-6">
				...
				<div className="flex items-start justify-between gap-6 mb-4 md:mb-6">
					<div className="flex-1">
						...
						<p className="text-gray-600 mt-2">Полностью укомплектованные наборы мебели для разных комнат</p>
					</div>
				...
				<div className="flex flex-wrap gap-2 md:gap-3 mb-6 md:mb-8">
					...
					{['Спальни', 'Гостиные', 'Кухни', 'Детские', 'Офисная мебель', 'Прихожие'].map((category) => (
						<button
							key={category}
					...
					<div className={`${isMobileFilterOpen ? 'fixed inset-0 z-50 bg-white overflow-y-auto' : 'hidden'} lg:block lg:w-52 lg:flex-shrink-0`}>
						...
						<div className="bg-white border-0 lg:border lg:border-gray-200 rounded-none lg:rounded-2xl p-4 lg:p-5 lg:sticky lg:top-4">
							...
							<div className="mb-5">
								...
								<div className="space-y-2">
									{['Классический', 'Современный', 'Скандинавский', 'Лофт', 'Минимализм'].map((style) => (
					...
					<div className="flex-1">
								...
								>
									<Link to={`/set/${set.id}`} className="block">
										...
										<div className="p-4">
											...
											<div className="flex items-center gap-2 mb-4">
												<span className="text-xl font-bold text-red-600">{set.price.toLocaleString()} ₽</span>
									...
									<div className="px-4 pb-4">
										<button
											...
											className={`w-full py-2.5 rounded-lg font-medium transition-colors whitespace-nowrap text-sm ${addedToCart.includes(set.id)
						...
						<div className="flex items-center justify-center gap-2 mt-8 md:mt-12">
							...
							{[1, 2, 3].map((page) => (
								<button
									key={page}
									className={`w-8 h-8 md:w-10 md:h-10 flex items-center justify-center rounded-lg font-medium cursor-pointer text-sm md:text-base ${page === 1 ? 'bg-red-600 text-white' : 'border border-gray-300 hover:border-red-600'
										}`}
								>
									{page}
								</button>
