          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="text-center">
                <div
                  className={`w-20 h-20 bg-${item.color}-100 rounded-full flex items-center justify-center mx-auto mb-4`}
                >
            ...
            {[
              {
                ...
                answer:
                  'Доставка бесплатна при заказе от 30 000 ₽. Для заказов меньшей суммы стоимость рассчитывается индивидуально в зависимости от габаритов товара и адреса доставки.',
              },
              {
                question: 'Можно ли выбрать точное время доставки?',
                answer:
                  'Да, при оформлении заказа вы можете выбрать удобный временной интервал. Наш менеджер свяжется с вами за день до доставки для уточнения времени.',
              },
              {
                question: 'Что входит в услугу сборки?',
                answer:
                  'Стандартная сборка включает: распаковку товара, сборку согласно инструкции, установку на место, вывоз упаковки. Гарантия на сборку - 12 месяцев.',
              },
              {
                question: 'Как происходит доставка крупногабаритной мебели?',
                answer:
                  'Крупногабаритная мебель доставляется специальным транспортом. Наши грузчики занесут товар в квартиру и поднимут на нужный этаж (лифтом или по лестнице).',
              },
              {
                question: 'Что делать, если товар не подошел?',
                answer:
                  'Вы можете вернуть товар в течение 14 дней с момента получения. Подробнее об условиях возврата читайте в разделе "Возврат товара".',
              },
            ].map((item, idx) => (
