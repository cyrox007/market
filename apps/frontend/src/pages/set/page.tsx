...
const setData = {
  1: {
    ...
    mainImage:
      'https://readdy.ai/api/search-image?query=elegant%20complete%20bedroom%20set%20with%20bed%20dresser%20nightstands%20wardrobe%20in%20classic%20style%20luxurious%20interior%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=800&height=600&seq=setmain1&orientation=landscape',
    galleryImages: [
    ...
    description:
      'Роскошный комплект мебели для спальни в классическом стиле. Включает двуспальную кровать, комод, две тумбочки и шкаф.',
    items: [
      {
        id: 101,
        ...
        price: 45990,
        image:
          'https://readdy.ai/api/search-image?query=elegant%20classic%20double%20bed%20with%20ornate%20headboard%20in%20luxurious%20bedroom%20interior%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=400&height=300&seq=item1-1&orientation=landscape',
        inSet: true,
      ...
      },
      {
        ...
        price: 32990,
        image:
          'https://readdy.ai/api/search-image?query=elegant%20classic%20bedroom%20dresser%20with%20mirror%20in%20luxurious%20interior%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=400&height=300&seq=item1-2&orientation=landscape',
        inSet: true,
      ...
      },
      {
        ...
        price: 24990,
        image:
          'https://readdy.ai/api/search-image?query=elegant%20classic%20bedside%20table%20nightstand%20in%20luxurious%20bedroom%20interior%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=400&height=300&seq=item1-3&orientation=landscape',
        inSet: true,
      ...
      },
      {
        ...
        price: 65990,
        image:
          'https://readdy.ai/api/search-image?query=elegant%20classic%20wardrobe%20with%20ornate%20details%20in%20luxurious%20bedroom%20interior%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=400&height=300&seq=item1-4&orientation=landscape',
        inSet: true,
      ...
      },
      {
        ...
        price: 28990,
        image:
          'https://readdy.ai/api/search-image?query=elegant%20classic%20vanity%20table%20with%20mirror%20in%20luxurious%20bedroom%20interior%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=400&height=300&seq=item1-5&orientation=landscape',
        inSet: true,
      ...
      },
      {
        ...
        price: 18990,
        image:
          'https://readdy.ai/api/search-image?query=elegant%20classic%20bedroom%20bench%20ottoman%20in%20luxurious%20interior%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=400&height=300&seq=item1-6&orientation=landscape',
        inSet: false,
      },
      {
        id: 107,
        ...
        price: 15990,
        image:
          'https://readdy.ai/api/search-image?query=elegant%20classic%20wall%20mirror%20with%20ornate%20frame%20in%20luxurious%20bedroom%20interior%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=400&height=300&seq=item1-7&orientation=landscape',
        inSet: false,
      },
      {
        id: 108,
        ...
        price: 35990,
        image:
          'https://readdy.ai/api/search-image?query=elegant%20classic%20armchair%20in%20luxurious%20bedroom%20interior%20white%20walls%20professional%20furniture%20photography%20clean%20simple%20background&width=400&height=300&seq=item1-8&orientation=landscape',
        inSet: false,
      },
    ],
  },
...
export default function SetPage() {
  ...
  const activeSetItems = set.items.filter(
    (item) => item.inSet && !removedFromSet.includes(item.id),
  );
  const setItemsTotal = activeSetItems.reduce((sum, item) => sum + item.price, 0);
  const selectedItemsTotal = set.items
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-[1280px] mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-2 text-xs sm:text-sm mb-6">
          ...
          <ChevronRight className="size-[1em] text-gray-400" />
          <Link to="/sets" className="text-gray-600 hover:text-red-600">
            Готовые комплекты
          </Link>
          <ChevronRight className="size-[1em] text-gray-400" />
                      ...
                      >
                        ...
                        {hoveredItem === item.id && (
                          <div
                            ...
                            style={{
                              left:
                                item.position!.left.includes('85') ||
                                item.position!.left.includes('70')
                                  ? 'auto'
                                  : '50%',
                              right:
                                item.position!.left.includes('85') ||
                          ...
                          >
                            <div className="relative mb-3">
                              ...
                              <div className="absolute top-2 right-2 flex gap-2">
                                ...
                                >
                                  <Heart
                                    className={`size-[1em] ${favorites.includes(item.id) ? 'text-red-500' : 'text-gray-600'}`}
          ...
          <div className="bg-gray-50 rounded-2xl p-6 h-fit sticky top-20">
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star
                    className="size-[1em] text-yellow-500 text-base"
              ...
              {removedFromSet.length === 0 && (
                <>
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    Экономия: {(set.oldPrice - set.price).toLocaleString()} ₽
                  </p>
                </>
              )}
              {removedFromSet.length > 0 && (
                <p className="text-xs text-gray-600 mt-1">
                  Товаров в комплекте: {activeSetItems.length}
                </p>
              )}
            </div>
                ...
                >
                  <div className="relative h-48">
                    ...
                    <div className="absolute top-3 right-3 flex gap-2">
                      ...
                      >
                        <Heart
                          className={`size-[1em] text-base ${favorites.includes(item.id) ? 'text-red-500' : 'text-red-600'}`}
                          fill={favorites.includes(item.id) ? 'currentColor' : 'none'}
                        />
                      </button>
                    </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600">
                    Выбрано {selectedItems.length} товаров (+ {activeSetItems.length} в комплекте)
                  </p>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-bold text-red-600">
                    {(selectedItemsTotal + setItemsTotal).toLocaleString()} ₽
                  </div>
                  <button
                    onClick={() => {
      ...
      {hoveredItem && <div className="fixed inset-0 z-40" onClick={() => setHoveredItem(null)} />}
    </div>
  );
}
