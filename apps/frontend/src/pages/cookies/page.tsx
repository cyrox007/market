...
export default function CookiesPage() {
	...
	return (
		...
		>
			...
			<p>
				Cookie — это небольшие файлы, которые сохраняются в браузере на вашем устройстве. Они помогают распознавать
				пользователя, сохранять настройки и обеспечивать работу отдельных функций сайта.
			</p>

			<h2>2. Какие cookie мы используем</h2>
			<ul>
				<li>
					<strong>Технические (обязательные)</strong> — необходимы для корректной работы сайта (например, сохранение
					выбора региона или содержимого корзины).
				</li>
				<li>
					<strong>Функциональные</strong> — запоминают ваши предпочтения и настройки интерфейса.
				</li>
				<li>
					<strong>Аналитические</strong> — помогают понять, как пользователи взаимодействуют с сайтом, чтобы улучшать
					сервис (если подключены системы аналитики).
				</li>
			</ul>
			...
			<p>
				Вы можете ограничить или отключить использование cookie в настройках браузера. Обратите внимание: отключение
				обязательных cookie может привести к некорректной работе сайта.
			</p>

			<h2>5. Контакты</h2>
			<p>
				По вопросам, связанным с обработкой данных и использованием cookie, вы можете связаться с нами:
				<br />
				{r.fullName}
				<br />
