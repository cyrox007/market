...
export default function CollectionPage() {
  ...
  const { wishlistProductIds: favorites, compareProductIds: compareList, mutateWishlist, mutateCompare } =
  ...
  const title =
    ...
    (slug ? COLLECTION_TITLE_FALLBACK[slug] : undefined) ??
    'Подборка';

  const notFound = Boolean(slug && !isLoading && (error as { status?: number } | undefined)?.status === 404);
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 py-6 md:py-12">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6" data-product-shop>
