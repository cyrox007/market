    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="space-y-6">
            {vacancies.map((vacancy) => (
              <div key={vacancy.id} className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-shadow">
        ...
        <div className="bg-gray-50 rounded-2xl p-12">
          ...
          <p className="text-center text-gray-600 mb-8">Отправьте нам свое резюме, и мы свяжемся с вами при появлении подходящей позиции</p>
